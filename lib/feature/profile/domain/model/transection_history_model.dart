...
class TtrancestionHistoryModel {
  ...
  factory TtrancestionHistoryModel.fromRawJson(String str) =>
      TtrancestionHistoryModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TtrancestionHistoryModel.fromJson(Map<String, dynamic> json) {
    return TtrancestionHistoryModel(
      ...
      data: json["data"] == null
          ? []
          : List<TtrancestionHistoryDataModel>.from(
              json["data"].map((x) => TtrancestionHistoryDataModel.fromJson(x)),
            ),
    );
  }
...
class TtrancestionHistoryDataModel {
  ...
  factory TtrancestionHistoryDataModel.fromJson(Map<String, dynamic> json) {
    return TtrancestionHistoryDataModel(
      id: safeString(json["_id"]),
      orderId: safeString(json["orderId"]),
      tipAmount: safeInt(json["tipAmount"]),
      ...
      pointsEarned: safeInt(json["pointsEarned"]),
      loyaltyPointsUsed: safeInt(json["loyaltyPointsUsed"]),
